...
Label(data_entry_frame, text='Spender\t             :', font=lbl_font, bg=dataentery_frame_bg).place(x=10, y=230)
...
table = ttk.Treeview(tree_frame, selectmode=BROWSE, columns=('ID', 'Date', 'Spender', 'Description', 'Amount', 'Mode of Payment'))
...
table.heading('Spender', text='Spender', anchor=CENTER)
